...
<!--code belows allows user to edit an administrator's profile-->
        ...
        <form action="UpdateAdministratorProfile.php" name = "admin_form" method="post" enctype="multipart/form-data" onsubmit = "return validateAllFields(this)">
            ...
            <label for="admin_middle_name"><b>Middle Name <abbr class="req" title="required">*</abbr></b></label> <span id="error-mname" span style = "float: right"></span><br>
            <input type="text" name="admin_middle_name" id = "admin_middle_name"  value="<?php echo $row1['admin_middle_name']; ?>" onblur ="validateMiddleName(admin_middle_name)" maxlength = "20" ><br>
            ...
            <input type="text" name="admin_last_name" id = "admin_last_name" value="<?php echo $row1['admin_last_name']; ?>" onblur ="validateLastName(admin_first_name)" maxlength = "20" required ><br>
            ...
            <label for="user_type">Administrator </label>
			<input  type="radio" name="user_type" id="user_type" value="Administrator" checked="checked"  /><br>
		...
		function validateFirstName(admin_first_name) //validates first name. Accepts certain characters. Cannot be blank.
		{
		...
		if(alpha.test(document.getElementById("admin_first_name").value))
			{
				document.getElementById("admin_first_name").style.background = "white";	//background of textbox
			...
			else if (!((admin_first_name.keyCode >= 65) && (admin_first_name.keyCode <= 90) || (admin_first_name.keyCode >= 97) && (admin_first_name.keyCode <= 122) || (admin_first_name.keyCode >= 48) && (admin_first_name.keyCode <= 57) && (!(admin_first_name.keyCode == 32)))) //special characters based on their ASCII code
			{
				document.getElementById("admin_first_name").style.background = "red";
				document.getElementById('error-fname').innerHTML = "Incorrect Input. Please use alphabetic characters, apostrophes and hyphens only.";
				return false;
		...
		function validateadminID(admin_id) //allows numerical characters only and length should be 8
		{
			var numbers = /^[0-9]+$/;
...
function validateAllFields ()
{
    if((document.getElementById('admin_first_name').style.background == "red") || (document.getElementById('admin_middle_name').style.background == "red") || (document.getElementById('admin_last_name').style.background == "red") || (document.getElementById('gender').style.background == "red") || (document.getElementById('ethnicity').style.background == "red") || (document.getElementById('date_of_birth').style.background == "red") || (document.getElementById('contact_number').style.background == "red") || (document.getElementById('house_number').style.background == "red") || (document.getElementById('street_name').style.background == "red") || (document.getElementById('suburb').style.background == "red") || (document.getElementById('post_code').style.background == "red") || (document.getElementById('school_code').style.background == "red") || (document.getElementById('admin_id').style.background == "red") || (document.getElementById('password').style.background == "red") || (document.getElementById("cPassword").style.background== "red"))
	{
			...
			{
				document.getElementByName("admin_form").submit(); //submits form
			}
		}
		</script>
