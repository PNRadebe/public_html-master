...
$query = $link->query("SELECT * FROM guardian WHERE guardian_id=$submit"); //fetches data for the entered id
...
<div class="super_container">
	...
	<div class="home">
        ...
        <form action="EditGuardianProfile.php" name = "guardian_form" method="post" enctype="multipart/form-data">
			...
			<label for="guardian_id"><b>Guardian ID <abbr class="req" title="required">*</abbr></b></label> <span id="error-fname" span style = "float: right"></span><br>
            <input type="text" name="guardian_id" id ="guardian_id" value="<?php echo $row1['guardian_id']; ?>"  maxlength = "20" readonly /><br>
