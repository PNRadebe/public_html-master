...
$query = $link->query("SELECT * FROM administrator WHERE admin_id=$submit"); //fetches data for the entered id
...
<div class="super_container">
	...
	<div class="home">
		...
		<div class="home_content">
			<h1>View Administrator Profile</h1>
		</div>
	</div>
        ...
        <form action="EditAdministratorProfile.php" name = "admin_form" method="post" enctype="multipart/form-data">

			<label for="admin_id"><b>Administrator ID <abbr class="req" title="required">*</abbr></b></label> <span id="error-fname" span style = "float: right"></span><br>
            <input type="text" name="admin_id" id ="admin_id" value="<?php echo $row1['admin_id']; ?>"  maxlength = "20" readonly /><br>
            ...
            <input type="text" name="admin_first_name" id ="admin_first_name" value="<?php echo $row1['admin_first_name']; ?>"  maxlength = "20" readonly /><br>
            ...
            <input type="text" name="admin_middle_name" id = "admin_middle_name"  value="<?php echo $row1['admin_middle_name']; ?>" maxlength = "20" readonly ><br>
            ...
            <input type="text" name="admin_last_name" id = "admin_last_name" value="<?php echo $row1['admin_last_name']; ?>" maxlength = "20" readonly ><br>
			...
			<input  type="radio" name="user_type" id="user_type" value="Administrator" checked="checked" readonly /><br>
		   ...
		   <input type="password" name="cPassword" id="cPassword" value="<?php echo $row1['cPassword']; ?>"  size="25" required><br>
            ...
            <input type="submit" name = "Edit" value = "Edit" onclick = "EditAdministratorProfile.php" />
