...
<div class="super_container">
	...
	<div class="home">
        ...
        <div class="container">
            <br><h2>Edit Teacher Profile</h2>

<!--code belows allows user to edit a teacher's profile-->
            <br>

            <h3>User Information</h3><br>
        <form action="UpdateTeacherProfile.php" name = "teacher_form" method="post" enctype="multipart/form-data" onsubmit = "return validateAllFields(this)">

			<label for="teacher_id"><b>Edit User ID <abbr class="req" title="required">*</abbr>:</b></label> <span id="error-adid" span style = "float: right"></span><br>
            ...
            <input type="text" name="teacher_first_name" id ="teacher_first_name" value="<?php echo $row1['teacher_first_name']; ?>" onblur ="validateFirstName(teacher_first_name)"  maxlength = "20" required /><br>

			<hr>

            <label for="teacher_middle_name"><b>Middle Name <abbr class="req" title="required">*</abbr></b></label> <span id="error-mname" span style = "float: right"></span><br>
            <input type="text" name="teacher_middle_name" id = "teacher_middle_name"  value="<?php echo $row1['teacher_middle_name']; ?>" onblur ="validateMiddleName(teacher_middle_name)" maxlength = "20" ><br>
            ...
            <input type="text" name="teacher_last_name" id = "teacher_last_name" value="<?php echo $row1['teacher_last_name']; ?>" onblur ="validateLastName(teacher_first_name)" maxlength = "20" required ><br>
            ...
            <label for="user_type">Teacher </label>
			<input  type="radio" name="user_type" id="user_type" value="Teacher" checked="checked"  /><br>
		...
		function validateFirstName(teacher_first_name) //validates first name. Accepts certain characters. Cannot be blank.
		{
		...
		if(alpha.test(document.getElementById("teacher_first_name").value))
			{
				document.getElementById("teacher_first_name").style.background = "white";	//background of textbox
			...
			else if (!((teacher_first_name.keyCode >= 65) && (teacher_first_name.keyCode <= 90) || (teacher_first_name.keyCode >= 97) && (teacher_first_name.keyCode <= 122) || (teacher_first_name.keyCode >= 48) && (teacher_first_name.keyCode <= 57) && (!(teacher_first_name.keyCode == 32)))) //special characters based on their ASCII code
			{
				document.getElementById("teacher_first_name").style.background = "red";
				document.getElementById('error-fname').innerHTML = "Incorrect Input. Please use alphabetic characters, apostrophes and hyphens only.";
				return false;
		...
		function validateteacherID(teacher_id) //allows numerical characters only and length should be 8
		{
			var numbers = /^[0-9]+$/;
...
function validateAllFields ()
{
    if((document.getElementById('teacher_first_name').style.background == "red") || (document.getElementById('teacher_middle_name').style.background == "red") || (document.getElementById('teacher_last_name').style.background == "red") || (document.getElementById('gender').style.background == "red") || (document.getElementById('ethnicity').style.background == "red") || (document.getElementById('date_of_birth').style.background == "red") || (document.getElementById('contact_number').style.background == "red") || (document.getElementById('house_number').style.background == "red") || (document.getElementById('street_name').style.background == "red") || (document.getElementById('suburb').style.background == "red") || (document.getElementById('post_code').style.background == "red") || (document.getElementById('school_code').style.background == "red") || (document.getElementById('teacher_id').style.background == "red") || (document.getElementById('password').style.background == "red") || (document.getElementById("cPassword").style.background== "red"))
	{
			...
			{
				document.getElementByName("teacher_form").submit(); //submits form
			}
		}
		</script>
