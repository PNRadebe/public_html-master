...
if(isset($_POST['Save']))
	{
		$admin_first_name = test_input($_POST['admin_first_name']);
		$admin_middle_name = test_input($_POST['admin_middle_name']);
		$admin_last_name = test_input($_POST['admin_last_name']);
		...
		else
		{
			...
			$sql = "UPDATE administrator SET admin_first_name='$admin_first_name', admin_middle_name='$admin_middle_name', admin_last_name='$admin_last_name', gender='$gender', ethnicity='$ethnicity', contact_number='$contact_number', house_number='$house_number', street_name='$street_name', suburb='$suburb', post_code='$post_code', user_type='$user_type', date_of_birth='$date_of_birth', password='$password' WHERE admin_id=$id";
