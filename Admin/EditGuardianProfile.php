...
<!--code belows allows user to edit a guardian's profile-->
            <br>
        ...
        <form action="UpdateGuardianProfile.php" name = "guardian_form" method="post" enctype="multipart/form-data" onsubmit = "return validateAllFields(this)">
			...
			<label for="guardian_id"><b>Edit User ID <abbr class="req" title="required">*</abbr>:</b></label> <span id="error-adid" span style = "float: right"></span><br>
