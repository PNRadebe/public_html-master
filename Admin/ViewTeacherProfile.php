...
<div class="super_container">
	...
	<div class="home">
        ...
        <form action="EditTeacherProfile.php" name = "teacher_form" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="teacher_middle_name" id = "teacher_middle_name"  value="<?php echo $row1['teacher_middle_name']; ?>" maxlength = "20" readonly ><br>
            ...
            <input type="text" name="teacher_last_name" id = "teacher_last_name" value="<?php echo $row1['teacher_last_name']; ?>" maxlength = "20" readonly ><br>
			...
			<input  type="radio" name="user_type" id="user_type" value="Teacher" checked="checked" readonly /><br>
