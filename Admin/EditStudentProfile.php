...
<div class="super_container">
	...
	<div class="home">
        ...
        <div class="container">
            <br><h2>Edit Student Profile</h2>

<!--code belows allows user to edit a student's profile-->
            <br>

            <h3>User Information</h3><br>
        <form action="UpdateStudentProfile.php" name = "student_form" method="post" enctype="multipart/form-data" onsubmit = "return validateAllFields(this)">

			<label for="student_id"><b>Edit User ID <abbr class="req" title="required">*</abbr>:</b></label> <span id="error-adid" span style = "float: right"></span><br>
            <input type="text" name="student_id" value="<?php echo $row1['student_id']; ?>" id="student_id" maxlength="8" readonly /><br>
            ...
            <input type="text" name="student_first_name" id ="student_first_name" value="<?php echo $row1['student_first_name']; ?>" onblur ="validateFirstName(student_first_name)"  maxlength = "20" required /><br>
            ...
            <input type="text" name="student_middle_name" id = "student_middle_name"  value="<?php echo $row1['student_middle_name']; ?>" onblur ="validateMiddleName(student_middle_name)" maxlength = "20" ><br>
            ...
            <input type="text" name="student_last_name" id = "student_last_name" value="<?php echo $row1['student_last_name']; ?>" onblur ="validateLastName(student_first_name)" maxlength = "20" required ><br>
