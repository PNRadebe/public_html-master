...
<div class="super_container">
	...
	<div class="home">
        ...
        <form action="EditStudentProfile.php" name = "student_form" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="student_middle_name" id = "student_middle_name"  value="<?php echo $row1['student_middle_name']; ?>" maxlength = "20" readonly ><br>
            ...
            <input type="text" name="student_last_name" id = "student_last_name" value="<?php echo $row1['student_last_name']; ?>" maxlength = "20" readonly ><br>
